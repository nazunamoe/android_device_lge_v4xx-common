...
BOARD_KERNEL_CMDLINE := console=none user_debug=31 msm_rtb.filter=0x37 androidboot.hardware=e8lte
...
TARGET_RECOVERY_FSTAB := device/lge/v4xx-common/rootdir/etc/fstab.e8lte
